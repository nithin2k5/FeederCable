...
("Reading the Screen", [
    ...
    ("kv", [
        ...
        ("Count", "Today's totals for this part: Total, OK, NG, NG%, PPM, the last cycle time and the running average."),
...
("Devices and COM Ports", [
    ("kv", [
        ...
        ("Label printer", "A thermal printer named EOLPRINTER, fed raw PRN templates."),
    ]),
