...
("Labels and Scanning", [
    ...
    ("p", "@lot3letters@ prints today's date as three characters: one for the "
          "day, one for the month, one for the year. 15 September 2026 is FIF — "
          "F for the 15th, I for September, F for 2026."),
    ...
    ("p", "As shipped the days run 1 to 9 then A to V, the months A to L, and "
          "the years A to T — 2021 to 2040. A customer who codes dates "
